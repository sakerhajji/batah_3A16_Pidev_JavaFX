...
public class Commandes {
    ...
    private Membre user_id;
    private boolean livraison;

    public Commandes(int id, String addresse, String region, Date date_creation, Membre user_id, boolean livraison) {
        this.id = id;
    ...
    public Commandes(int id, String addresse, String region, Date date_creation, Membre user_id) {
        this.id = id;
        this.addresse = addresse;
        this.region = region;
        this.date_creation = date_creation;
    ...
    public Membre getUser_id() {
        return user_id;
    }

    public void setUser_id(Membre user_id) {
        this.user_id = user_id;
    }
    ...
    public String toString() {
        return "Commandes{" + "id=" + id + ", addresse=" + addresse + ", region=" + region + ", date_creation=" + date_creation + ", user_id=" + user_id + ", livraison=" + livraison + '}';
    }
