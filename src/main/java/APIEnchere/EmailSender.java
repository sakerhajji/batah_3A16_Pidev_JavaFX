...
public class EmailSender {
    public static void sendConfirmationEmail(String userEmail, String enchereDescription, String userName) {
        ...
        String username = "benrhoumawala249@gmail.com"; // Votre adresse e-mail Gmail
        String password = "ukcx jidc pzmx xwij"; // Votre mot de passe Gmail
        ...
        try {
            ...
            message.setSubject("Confirmation de réservation"); // Objet de l'e-mail
            String emailContent = "Bonjour " + userName + ",\n\n"
                    + "Félicitations ! Votre réservation pour l'enchère \"" + enchereDescription + "\" a été confirmée.\n\n"
                    + "Merci de votre participation.\n\n"
                    + "Cordialement,\n"
                    + "Votre équipe de gestion des enchères"; // Contenu de l'e-mail
    ...
    public static void main(String[] args) {
        ...
        sendConfirmationEmail("adresse_email_destinataire@example.com", "Description de l'enchère", "Nom de l'utilisateur");
    }
}
